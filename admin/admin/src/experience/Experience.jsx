...
import { deleteExperience, getAllExperience } from "../ApiServices/ApiCallService";
...
const Experience = () => {
  ...
  const getExperiences = async () => {
    try {
      const res = await getAllExperience(searchTerm, currentPage, 10);

      if (res && !res.error) {
        setDetails(res?.data?.data?.experience || []);
